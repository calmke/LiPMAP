...
parser.add_argument("--data_root", type=str, default="./data/ScanNetPP/scans", help='root path to scannet dataset')
parser.add_argument("--save_root", type=str, default="./data/general_data/ScanNetPP", help='path to save processed results')
...
for i in tqdm(range(len(image_path)), desc=f"convert ScanNetPP {args.scene_id} into a generic format"):
